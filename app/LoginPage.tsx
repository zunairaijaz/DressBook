...
const LoginPage: React.FC = () => {
  ...
  const inputClasses =
    "appearance-none relative block w-full px-4 py-3 border-2 border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-accent focus:border-accent focus:z-10 sm:text-sm";
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-lg shadow-md">
        ...
        <div className="text-sm text-center">
          <p className="text-gray-600">
            New to The Dress Book?{" "}
            <Link
              href="/signup"
              className="font-medium text-blue-600 hover:text-accent-hover"
            >
              Create an account
            </Link>
          </p>
