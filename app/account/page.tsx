...
const AccountPage: React.FC = () => {
    ...
    const orders: Partial<Order>[] = [
        { id: 'WU88191111', date: 'January 22, 2023', datetime: '2023-01-22', status: 'Delivered', total: 140.00 },
        { id: 'WU88191112', date: 'July 12, 2022', datetime: '2022-07-12', status: 'Cancelled', total: 350.00 },
    ];
